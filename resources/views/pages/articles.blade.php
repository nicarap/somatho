                    ...
                    <div class="lg:flex flex-grow items-center bg-white lg:bg-transparent lg:shadow-none hidden">
                        <ul class="flex flex-col lg:flex-row list-none lg:ml-auto">
                            <li class="flex items-center">
                                <a class="lg:text-primary-800 hover:text-primary-400 hover:underline duration-100 transition-all px-3 py-4 lg:py-2 flex items-center text-md uppercase font-bold" href="{{ route('home') }}/#somatopathy">
                                    <span class="inline-block ml-2">Somatopathie</span>
                                </a>
                            </li>
                            <li class="flex items-center">
                                <a class="lg:text-primary-800 hover:text-primary-400 hover:underline px-3 py-4 lg:py-2 flex items-center text-md uppercase font-bold" href="{{ route('home') }}/#reasons">
                                    <span class="inline-block ml-2">Pour qui ?</span>
                                </a>
                            </li>
                            <li class="flex items-center">
                                <a class="lg:text-primary-800 hover:text-primary-400 hover:underline px-3 py-4 lg:py-2 flex items-center text-md uppercase font-bold" href="{{ route('home') }}/#contact">
                                    <span class="inline-block ml-2">Contact</span>
                                </a>
                            </li>
                            <li class="flex items-center">
                                <a class="lg:text-primary-800 hover:text-primary-400 hover:underline px-3 py-4 lg:py-2 flex items-center text-md uppercase font-bold" href="{{ route('article.viewAny') }}">
