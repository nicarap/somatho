    ...
    <div class="relative bg-white cursor-default flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg gs_reveal">
        ...
        <div class="p-2">
            ...
            <div class="flex justify-end mt-8">
                <a href="{{ route('article', ['article' => $article]) }}" class="hover:bg-secondary-500/50 text-secondary-900 text-sm font-bold uppercase px-3 py-1 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1" type="submit" style="transition: all 0.15s ease 0s;">
