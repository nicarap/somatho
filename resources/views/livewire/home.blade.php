    ...
    <section class="pb-20 bg-primary-200">
        <div class="container mx-auto px-4 -mt-24">
            <div class="flex flex-wrap">
                <div class="lg:pt-12 pt-6 w-full md:w-4/12 px-4 text-center gs_reveal ">
                ...
                <div class="w-full md:w-4/12 px-4 text-center gs_reveal ">
                    <div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                        <div class="px-4 py-5 flex-auto">
                ...
                <div class="pt-6 w-full md:w-4/12 px-4 text-center gs_reveal ">
                    <div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                        <div class="px-4 py-5 flex-auto">
