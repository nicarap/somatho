<div>
    <x-slot:main-title>
        ...
        <h1 class="text-5xl px-4 text-center font-antiqua font-light leading-relaxed mt-4 mb-4 text-primary-200">
    ...
    <section class="hidden z-30 lg:block 2xl:pb-20 relative bg-primary-200">
        ...
        <div class="container relative 2xl:h-16 mx-auto px-4">
            <div class="flex justify-center 2xl:absolute -top-32 flex-wrap">
                <div class="lg:pt-12 pt-6 w-full 6/12 md:w-5/12 xl:w-4/12 px-4 text-center">
                ...
                <div class="hidden xl:block w-full md:w-4/12 px-4 text-center">
                    <div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                        <div class="px-4 py-5 flex-auto">
                            <div
                                class="p-3 text-center inline-flex items-center justify-center w-12 h-12 mb-5 shadow-lg rounded-full border-2 border-primary-500 text-primary-500">
                ...
                <div class="pt-6 w-full md:w-5/12 xl:w-4/12 px-4 text-center">
                    <div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                        <div class="px-4 py-5 flex-auto">
                            <div
                                class="p-3 text-center inline-flex items-center justify-center w-12 h-12 mb-5 shadow-lg rounded-full border-2 border-primary-500 text-primary-500">
    ...
    <section class="min-h-screen flex justify-between flex-col" id="reasons">
        <div class="relative">
            <div class="custom-shape-divider-top-1703755415 -top-1 md:-top-3" style="
                    position: absolute;
                    left: 0;
                    width: 100%;
                    overflow: hidden;
            ...
            <div class="container mx-auto py-12 px-4">
                <div class="flex flex-wrap justify-center text-center">
                    <div class="w-full max-w-7xl px-4">
                        ...
                        <p class="hidden md:block text-xl font-semibold leading-relaxed mt-4 mb-4 text-gray-500">Bienvenue
                            dans
                            l'univers de
                            la somatopathie !</p>
                    </div>
                ...
                <div
                    class="hidden md:grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 items-stretch gap-8 py-8">
