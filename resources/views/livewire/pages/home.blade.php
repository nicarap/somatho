<div>
    <x-slot:main-title>
        <div class="fill-secondary-500 aspect-auto" style="width:400px">@include('logo.name')</div>
        <div class="fill-secondary-500 my-4" style="width:500px">@include('logo.slogan')</div>
    </x-slot:main-title>
                ...
                <div class="lg:pt-12 pt-6 w-full md:w-4/12 px-4 text-center">
                    <div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                        <div class="px-4 py-5 flex-auto">
                            <div class="p-3 text-center inline-flex items-center justify-center w-12 h-12 mb-5 shadow-lg rounded-full border border-secondary-900 text-secondary-900 bg-secondary-50">
                ...
                <div class="pt-6 w-full md:w-4/12 px-4 text-center">
                    <div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                        <div class="px-4 py-5 flex-auto">
                            ...
                            <p class="mt-2 mb-4 text-gray-600">
                                Je suis Amelie Bonzi et je met à votre disposition une passion dédiée à l'amélioration de votre bien-être grâce à la somatopathie.
                            </p>
    ...
    <section class="relative block pb-20 lg:pt-12" id="articles">
        <div class="container mx-auto my-12 px-4">
            ...
            <livewire:components.articles :articles="App\Models\Article::published()->orderBy('published_at')->limit(4)->get()" />

            <div class="text-center mt-8">
                <a href="{{ route('articles') }}" class="bg-primary-900 text-white hover:bg-primary-500 text-sm font-bold uppercase px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 transition-all duration-300">
