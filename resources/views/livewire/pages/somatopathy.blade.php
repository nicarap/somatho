<div>
    ...
    <main class="relative">
        ...
        <div class="pb-20 bg-gray-100 pt-20">
                ...
                <div class="flex flex-wrap items-center">
                    <div class="w-full md:w-5/12 px-4 mr-auto ml-auto gs_reveal gs_reveal_fromLeft">
                        ...
                        <p class="text-lg font-light leading-relaxed mt-0 mb-4 text-gray-700">
                            La méthode POYET est une technique manuelle globale qui prend en compte le corps comme un
                            tout.
                        ...
                        <p class="text-lg font-light leading-relaxed mt-0 mb-4 text-gray-700">
                            ...
                            <a href="https://fr.wikipedia.org/wiki/William_Garner_Sutherland"
                                class="font-bold hover:underline text-gray-800 mt-8">William G. Shuterland</a>
        ...
        <div class="relative bg-primary-500 overflow-hidden">
            <div class="max-w-7xl mx-auto">
                <div
                    class="relative z-10 pb-8 bg-transparant lg:bg-primary-500 sm:pb-16 md:pb-20 lg:max-w-2xl lg:w-full lg:pb-28 xl:pb-32">
                    <svg class="hidden lg:block absolute right-0 inset-y-0 h-full w-48 text-primary-500 transform translate-x-3/4"
                    ...
                    <div class="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
                        <div class="sm:text-center lg:text-left">
                            <p class="text-white text-justify text-xl md:text-center">
                                Explorez le potentiel transformateur de la Somatopathie avec la Méthode Poyet. Découvrez
                                comment
                                cette approche unique peut vous aider à retrouver l'équilibre et à libérer votre plein
                                potentiel.
                            </p>
                        </div>
                ...
                <div class="absolute inset-0 lg:inset-y-0 lg:right-0 lg:w-1/2 bg-auto bg-no-repeat bg-fixed bg-right"
