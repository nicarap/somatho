                        ...
                        <div class="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
                            <div class="sm:text-center lg:text-left">
                                <p class="text-white text-justify text-xl md:text-center">
                                    Explorez le potentiel transformateur de la Somatopathie avec la Méthode Poyet.
                                    Découvrez
                                    comment
                                    cette approche unique peut vous aider à retrouver l'équilibre et à libérer votre
                                    plein
                                    potentiel.
                                </p>
                            </div>
