    ...
    <main class="relative">
                ...
                <div class="flex flex-wrap items-center">
                    <div class="w-full md:w-5/12 px-4 mr-auto ml-auto gs_reveal gs_reveal_fromLeft">
                        <div
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-2/3"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 pt-32">
                    <div class="w-full px-4 mr-auto ml-auto gs_reveal gs_reveal_fromLeft">
                        <div class="fill-secondary-900 gap-4 inline-flex items-center justify-center ">
                            ...
                            <h3 class="text-3xl font-semibold whitespace-nowrap transition-all duration-300">
        ...
        <div id="about" class="relative bg-primary-500 overflow-hidden mt-16">
            <div class="max-w-7xl mx-auto">
                ...
                <div class="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2 bg-auto bg-no-repeat bg-fixed bg-right"
