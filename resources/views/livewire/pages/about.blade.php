<div>
    <x-slot:main-title>
        <h1 class="text-5xl font-serif font-light leading-relaxed mt-4 mb-4 text-secondary-500">
            A propos de moi
        </h1>
    </x-slot:main-title>
            ...
            <div class="flex flex-wrap items-center">
                ...
                <div class="w-full md:w-5/12 px-4 mr-auto ml-auto gs_reveal gs_reveal_fromRight">
                    ...
                    <p class="text-lg font-light leading-relaxed mt-4 mb-4 text-gray-700">
                        Thérapeute en somatopathie, je m'engage à rétablir l'harmonie entre votre corps et votre esprit,
                    ...
                    <p class="text-lg font-light leading-relaxed mt-0 mb-4 text-gray-700">
                        Je vous accueille au sein du Centre de Santé <a href="https://www.secondeviereunion.com/"
                           class="font-bold text-primary-900 hover:underline mt-8">Seconde Vie</a> jusqu'à mars 2024, où
