    ...
    <main class="relative">
        ...
        <div class="bg-gray-100">
            ...
            <div class="bg-primary-500 py-32">
                <div class="container mx-auto px-4 ">
                    <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-16 justify-center relative z-20">
                        <div class="">
                            <div
        ...
        <div class="relative bg-primary-200 overflow-hidden">
            <div class="max-w-7xl mx-auto">
                <div
                    class="relative md:w-1/2 z-10 pb-8 bg-transparant md:bg-primary-200 sm:pb-16 md:pb-20 lg:max-w-2xl lg:w-full lg:pb-28 xl:pb-32">
                    <div class="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
                        <div class="sm:text-center lg:text-left">
                            <p class="text-white text-xl md:text-center text-justify">
                ...
                <div class="absolute inset-0 lg:right-0 lg:w-1/2 bg-auto bg-no-repeat bg-fixed bg-right-bottom"
