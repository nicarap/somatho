                    ...
                    <div class="flex w-full gap-4 items-stretch">
                        ...
                        <div class="text-gray-100  text-justify flex flex-col justify-between">
                            ...
                            <p>
                                ...
                                Forte de ma passion et de mon expertise en somatopathie, je vous guide à travers mes soins, vous offrant une perspective unique sur le bien-être
                            </p>
                            <p>
                                Êtes-vous prêt à embarquer dans ce voyage transformateur à mes côtés ? Je suis 
                                <a href="{{ route('about') }}" class="font-bold hover:underline text-secondary-500">Amélie Bonzi</a>, 
