        ...
        <div class="flex-auto p-5 lg:p-10">
            ...
            @if ($message_sended_successfull)
                <div class="flex gap-2 items-center">
                    ...
                    <span class="text-xs leading-relaxed text-green-900">Votre message à été envoyé avec
                        succès.</span>
                </div>
            @endif
            ...
            @if ($message_sended_error)
                <div class="flex gap-2 items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" class="fill-secondary-500" height="16" width="16"
                         viewBox="0 0 512 512">
                        <!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2023 Fonticons, Inc.-->
                        <path
                    ...
                    <span class="text-xs leading-relaxed text-secondary-500">Votre message n'a pas pu être
                        envoyé.</span>
                </div>
            @endif
            ...
            @if ($message_captcha_error)
                <div class="flex gap-2 items-center">
                    ...
                    <span class="text-xs leading-relaxed text-secondary-500">Google pense que vous êtes un robot.
                        Veuillez
                        rééssayer</span>
                </div>
            @endif
            ...
            <div class="mt-2">
                ...
                <div class="mt-2 w-full flex gap-2 items-center">
                    <a title="BonziSomato" href="{{ config('app.social_medias.facebook') }}" target="_blank"
                       class="flex fill-gray-200 bg-primary-900 hover:fill-primary-900 hover:bg-gray-200 shadow-lg font-normal h-8 w-8 items-center justify-center align-center rounded-full outline-none focus:outline-none mr-2 p-1"
                       type="button">
