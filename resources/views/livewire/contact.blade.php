    ...
    <div class="relative flex flex-col min-w-0 break-words w-full shadow-lg md:rounded-lg bg-primary-500">
        <div class="flex-auto p-5 lg:p-10">
            ...
            <div class="relative w-full">
                <div class="mb-2">
                    <label class="block uppercase text-gray-200 text-xs font-bold" for="message">Message /
            ...
            @if ($message_sended_successfull)
                <div class="flex gap-2 items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" class="fill-green-200" height="16" width="16"
                         viewBox="0 0 512 512">
                    ...
                    <span class="text-xs leading-relaxed text-green-200">Votre message à été envoyé avec
                        succès.</span>
                </div>
            @endif
            ...
            <div class="mt-2">
                ...
                <div class="mt-2 w-full flex gap-2 items-center">
                    <a title="facebook" href="{{ config('app.social_medias.facebook') }}" target="_blank"
                       class="flex fill-primary-500 bg-primary-900 hover:bg-primary-50 shadow-lg font-normal h-8 w-8 items-center justify-center align-center rounded-full outline-none focus:outline-none mr-2 p-1"
                       type="button">
                    ...
                    <a title="+33 617 80 50 24" href="{{ config('app.social_medias.whatapps') }}" target="_blank"
                       class="flex fill-primary-500 bg-primary-900 hover:bg-primary-50 shadow-lg font-normal h-8 w-8 items-center justify-center align-center rounded-full outline-none focus:outline-none mr-2 p-1"
                       type="button">
                        <svg xmlns="http://www.w3.org/2000/svg" height="12" width="14" viewBox="0 0 448 512">
                            <!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
                            <path
