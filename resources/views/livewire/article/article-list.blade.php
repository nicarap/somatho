<div class="bg-gradient-to-b from-primary-200 from-50% to-white">
    ...
    <div class="max-w-3xl mx-auto w-full py-16 px-4">
        <div class="w-full px-4">
            <h2 class="text-xl font-semibold text-primary-400">Je vous partages plusieurs articles sur la somatopathie tiré de mes connaissances, mon experience.</h2>
        </div>
        <div class="max-w-3xl mx-auto w-full pt-12 pb-24">
                ...
                <div class="border bg-white p-4 ">
                    <div class="flex justify-between items-end">
                        <div class="flex-1">
                            ...
                            <div class="line-clamp-1">{!! $article->content !!}</div>
