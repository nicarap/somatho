    ...
    <div class="flex flex-wrap items-center">
        ...
        <div class="w-full md:w-3/12 px-4 mr-auto ml-auto  gs_reveal gs_reveal_fromLeft">
            <div class="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-primary-400">
                <img alt="Soin de somatopathie réalisé sur une douleur au genou" src="{{ asset('images/soin_sur_genou_amelie_bonzi.jpg') }}" class="w-full align-middle rounded-lg" style="height: 500px;" />
        ...
        <div class="w-full md:w-5/12 px-4 mr-auto ml-auto gs_reveal gs_reveal_fromRight">
            <div class="fill-secondary-900 p-3 border-2 border-secondary-900/50 text-center inline-flex items-center justify-center w-16 h-16 mb-6 shadow-lg rounded-full bg-secondary-50">
            ...
            <p class="text-lg font-light leading-relaxed mt-4 mb-4 text-gray-100">
            ...
            <p class="text-lg font-light leading-relaxed mt-0 mb-4 text-gray-100">
