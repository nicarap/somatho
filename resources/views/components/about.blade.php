        ...
        <div class="w-full md:w-3/12 px-4 mr-auto ml-auto  gs_reveal gs_reveal_fromLeft">
            <div class="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-primary-400">
                <img alt="Soin de somatopathie réalisé sur une douleur au genou"
                     src="{{ asset('images/soin_sur_genou_amelie_bonzi.jpg') }}" class="w-full align-middle rounded-lg"
                     style="height: 500px;" />
        ...
        <div class="w-full md:w-5/12 px-4 mr-auto ml-auto gs_reveal gs_reveal_fromRight">
            ...
            <p class="text-lg font-light leading-relaxed mt-4 mb-4 text-gray-600">
                Je suis <a href="https://www.instagram.com/abonzisomato/"
                   class="font-bold text-primary-900 hover:underline mt-8">Amelie Bonzi</a>, thérapeute en somatopathie.
            ...
            <p class="text-lg font-light leading-relaxed mt-0 mb-4 text-gray-600">
                Je vous accueille au sein du Centre de Santé <a href="https://www.secondeviereunion.com/"
                   class="font-bold text-primary-900 hover:underline mt-8">Seconde Vie</a> à Saint Pierre de La Réunion,
                jusqu'à mars 2024, où
                j'applique une approche manuelle douce visant à traiter tant les douleurs physiques que les troubles
                émotionnels
            </p>
            <p class="text-lg font-light leading-relaxed mt-0 mb-4 text-gray-600">
                Je vous ferez découvrir la méthode Poyet qui, en combinant des techniques précises et une compréhension
