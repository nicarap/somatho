<footer class="relative w-full bg-primary-900 pt-8 pb-6">
    <div class="container mx-auto px-4 snap-always snap-mandatory">
        <div class="flex flex-wrap">
            <div class="w-full lg:w-6/12 px-4">
                ...
                <div class="mt-2 flex gap-2 items-center">
                    <a title="facebook" href="https://www.facebook.com/?locale=fr_FR" target="_blank"
                    ...
                    <a title="abonzisomato" href="https://www.instagram.com/abonzisomato/" target="_blank"
                       class="flex fill-secondary-900 bg-gray-100 hover:bg-secondary-500 shadow-lg font-normal h-10 w-10 items-center justify-center align-center rounded-full outline-none focus:outline-none mr-2 p-3"
                       type="button">
                        <svg xmlns="http://www.w3.org/2000/svg" height="16"
                    ...
                    <a title="+33 617 80 50 24" href="https://wa.me/+33617805024" target="_blank"
                       class="flex fill-secondary-900 bg-gray-100 hover:bg-secondary-500 shadow-lg font-normal h-10 w-10 items-center justify-center align-center rounded-full outline-none focus:outline-none mr-2 p-3"
                       type="button">
        ...
        <hr class="my-6 border-primary-500 snap-always snap-center" />
