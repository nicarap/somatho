<div class="container mx-auto px-4 pt-20">
    <div class="flex flex-wrap items-center">
        <div class="w-full md:w-5/12 px-4 mr-auto ml-auto gs_reveal gs_reveal_fromLeft">
            <div class="fill-primary-900 p-3 border-2 bg-primary-200 border-primary-900/50 text-center inline-flex items-center justify-center w-16 h-16 mb-6 shadow-lg rounded-full">
            ...
            <p class="text-lg font-light leading-relaxed mt-4 mb-4 text-gray-700">
                La somatopathie, souvent méconnue, offre une approche unique pour comprendre et harmoniser les liens entre nos émotions, 
                notre corps et notre bien-être global. Que vous soyez novice en la matière ou que vous ayez déjà entamé ce voyage fascinant, 
            ...
            <p class="text-lg font-light leading-relaxed mt-0 mb-4 text-gray-700">
                ...
                Cliquez sur le bouton ci-dessous pour en apprendre davantage et commencez votre voyage vers une vie plus épanouissante, équilibrée et consciente.
            </p>
            ...
            <div class="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-primary-200">
                ...
                <blockquote class="relative p-8 mb-4">
                    <svg preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 583 95" class="absolute left-0 w-full block" style="height: 95px; top: -94px;">
                        <polygon points="-30,95 583,95 583,65" class="text-primary-200 fill-current"></polygon>
                    </svg>
                    ...
                    <p class="text-md font-light mt-2 text-gray-700">
                        Cette approche précise vise à rétablir l'alignement structurel en travaillant en harmonie avec le 
                        mouvement respiratoire naturel du corps, indispensable au bon fonctionnement de l'organisme.
                    </p>
                </blockquote>
            </div>
        </div>
