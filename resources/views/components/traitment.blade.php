<div class="container mx-auto px-4 pt-20">
    <div class="flex flex-wrap text-center justify-center">
        <div class="w-full lg:w-6/12 px-4">
            ...
            <p class="text-lg leading-relaxed mt-4 mb-4 text-gray-800">
                La séance peut se dérouler au Centre de bien être <a href="https://www.secondeviereunion.com/"
                   target="_blank" class="hover:underline text-secondary-900">Seconde Vie</a> à Saint Pierre ou a domicile
                dans l'ouest
                et le sud de
                l'île de La Réunion.
            </p>
