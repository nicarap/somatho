    ...
    <div class="items-center flex flex-wrap">
        ...
        <div class="w-full md:w-5/12 ml-auto mr-auto px-4">
            <div class="md:pr-12">
                ...
                <h3 class="text-3xl font-semibold">Les domaines d'applications</h3>
                ...
                <ul class="list-none mt-6">
                    <li class="py-2">
                        <div class="flex items-start gap-1">
                            <div>
                                <span class="inline-flex fill-secondary-600 p-2 text-center items-center justify-center w-6 h-6 mb-6 shadow-lg rounded-full bg-secondary-200">
                            ...
                            <div>
                                ...
                                <p class="mt-4 text-md leading-relaxed text-gray-600">
                                    Vous pouvez consulter suite :
                                <ul class="ml-4">
                                    <li class="text-md leading-relaxed text-gray-600">
                                        Suite a un choc physique (chute, accident, mauvais mouvement…)
                                    </li>
                                    <li class="text-md leading-relaxed text-gray-600">
                                        Suite a un choc émotionnel (séparation, licenciement, deuil, mauvaise nouvelle…)
                                    </li>
                                    <li class="text-md leading-relaxed text-gray-600">
                    ...
                    <li class="py-2">
                        <div class="flex items-start gap-1">
                            <div>
                                <span class="inline-flex fill-secondary-600 p-1.5 text-center items-center justify-center w-6 h-6 mb-6 shadow-lg rounded-full bg-secondary-200">
